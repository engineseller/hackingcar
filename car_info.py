...
while True:
    ...
    print
    'RPM : ' + str(connection.query(obd.commands.RPM).value)
    print
    'Fuel Level: ' + str(connection.query(obd.commands.FUEL_LEVEL).value)
    print
    'Engine Temp : ' + \
    ...
    print
    'Stored DTCs: ' + str(connection.query(obd.commands.GET_DTC).value)
    print
    'UpTme: ' + str(connection.query(obd.commands.RUN_TIME).value)
    print
    '\n'
    print
    'Weather Information:'
